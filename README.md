...
podman build --squash -t quay.io/wangzheng422/qimgs:simple-java-http-server-threads-2024.05.30.v03 -f Dockerfile.simple ./

podman push quay.io/wangzheng422/qimgs:simple-java-http-server-threads-2024.05.30.v03
